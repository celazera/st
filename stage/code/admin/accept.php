...
// Handle reject and delete actions
...
// Query to fetch accepted offers
...
// Initialize array to store accepted offers
$accepted_offres = [];
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        // Create a list item for each accepted offer
        $accepted_offres[] = "<tr>
                                    <td>$company_name</td>
                                    <td>$offre_titre</td>
...
<body>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tbody>
                <?php
                if (!empty($accepted_offres)) {
                    foreach ($accepted_offres as $offre) {
                        echo $offre;
                    }
                } else {
                    echo "<tr><td colspan='5'>Aucune offre acceptée trouvée</td></tr>";
                }
                ?>
            </tbody>
        </table>
